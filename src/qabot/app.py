...
class EcsClusterQaBot(core.Stack):
    def __init__(self, scope: core.App, name: str, key_name: str, **kwargs) -> None:
        ...
        # ECSクラスターを定義。クラスター=仮想サーバーのプール、クラスターの中に複数の仮想インスタンスを配置。
        cluster = ecs.Cluster(self, "EcsClusterQaBot-Cluster", vpc=vpc)
        ...
        # print the cluster name and task definition arn
